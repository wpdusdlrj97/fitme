...
{
    $_SESSION['URL'] = 'http://49.247.136.36/developer/register.php'; //이 페이지로 다시 되돌아 오기 위해 세션에 이 페이지의 URL을 넣는다.
...
//$time=JSON_EXTRACT(additional_information, '$.time');
...
<div id="page-wrapper">
    ...
    <section id="header" class="wrapper">
        ...
        <div id="logo">
            ...
            <br>
            <p>
            <h1 style="color:#FFFFFF;  font-size: 1em; text-align:center;"><?php echo $email; ?>님</h1></p>
    ...
    <section id="main" class="wrapper style2">
        <div class="title">Application 등록</div>
        <div class="container">
                            ...
                            <ul class="style2">
                                <li>
                                    <article class="box post-excerpt">
                                        <a href="http://49.247.136.36/developer/myapplication.php"
                                           class="image left"><img src="images/pic08.jpg" alt=""/></a>
                                        <h3><a href="http://49.247.136.36/developer/myapplication.php">나의 어플리케이션</a>
                                        </h3>
                                ...
                                <li>
                                    <article class="box post-excerpt">
                                        ...
                                        <h3><a href="#">어플리케이션 등록</a></h3>
                                        <p>API 이용을 위해 애플리케이션을 등록하는 곳입니다</p>
                                    </article>
                                </li>
                                <li>
                                    <article class="box post-excerpt">
                                        <a href="http://49.247.136.36/developer/demo.php" class="image left"><img
                ...
                <div class="col-8 col-12-medium imp-medium">
                    ...
                    <div id="content">
                        <article class="box post">
                            <br><br>
                            <header class="style2">
                                <h2>애플리케이션 등록 (API 이용신청)</h2>save
                            </header>
                            <form action="http://15.165.80.29/save" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <select id="clientType" name="clientType" class="selectpicker">
                                ...
                                <div class="form-group">
                                    <button class="button style1" type="submit">Register</button>
                                    <button class="button style1" type="button"
                                            onclick="javascript: window.location.href='/'">Cancel
                                    </button>
                                </div>
                            </form>
                        </article>
