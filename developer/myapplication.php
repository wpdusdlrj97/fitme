...
{
    $_SESSION['URL'] = 'http://49.247.136.36/developer/myapplication.php'; //이 페이지로 다시 되돌아 오기 위해 세션에 이 페이지의 URL을 넣는다.
...
//시간 순으로 정렬하기
    $query = "SELECT * FROM oauth_client_details where additional_information like '%$email%' ";
                                ...
                                <ul class="style2">
                                    <li>
                                        <article class="box post-excerpt">
                                            ...
                                            <h3><a href="#">나의 어플리케이션</a></h3>
                                            <p> FitMe API를 이용하기 위해 자신이 등록한 어플의 상세정보를 조회할 수 있습니다</p>
                                        </article>
                                    </li>
                                    <li>
                                        <article class="box post-excerpt">
                                            <a href="http://49.247.136.36/developer/register.php"
                            ...
                            <article class="box post">
                                ...
                                <table id="customers">
                                    ...
                                    while ($rows = mysqli_fetch_assoc($result)) { //DB에 저장된 데이터 수 (열 기준)
                                        ...
                                        <?php } ?>
                                        <td width="200" align="center"><?php echo $rows['client_id'] ?></td>
                                        <td width="50" align="center"><?php
                                            /* PHP JSON parser sample */

                                            $json = json_decode($rows['additional_information'], true);
                                            echo $json['name'] ?>
                                        </td>
                                        <td width="50" align="center"><a
                                                    href="/developer/detail_app.php?client_id=<?= $rows['client_id'] ?>">자세히보기
                                        </td>
                                        </tr>
                                        <?php
                                        $total--;
