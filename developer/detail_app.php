...
{
    $_SESSION['URL'] = 'http://49.247.136.36/developer/detail_app.php'; //이 페이지로 다시 되돌아 오기 위해 세션에 이 페이지의 URL을 넣는다.
...
$query ="select * from oauth_client_details where client_id='$client_id'";
          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                ...
                <li><a href="http://49.247.136.36/register.php">어플리케이션 등록</a></li>
        ...
        <li><a href="no-sidebar.html">No Sidebar</a></li>
			...
			<!-- Main -->
              ...
              <ul class="style2">
                ...
                <li>
                  <article class="box post-excerpt">
                    <a href="http://49.247.136.36/register.php" class="image left"><img src="images/pic09.jpg" alt="" /></a>
                    <h3><a href="http://49.247.136.36/register.php">어플리케이션 등록</a></h3>
                  ...
                  <article class="box post-excerpt">
                    ...
                    <p>FitMe API 이용 Demo 영상</p>
                      ...
                      <button class="button style1" type="button"
                        onclick="javascript: window.location.href='http://49.247.136.36/developer/delete_app.php?client_id=<?=$row['client_id']?>'">삭제</button>
                      <h1 style="color:#eb1010; font-size: 0.7em;">
                        *애플리케이션을 삭제하면 애플리케이션에 설정된 정보들과 API 설정들은 복구되지 않으므로 신중하게 삭제해 주시기 바랍니다.*
