        ...
        <div id="main" class="wrapper style1">
            ...
            <div class="card card-container" style="border:4px solid black;">
                ...
                <form method="post" action="http://49.247.136.36/main/fitme_session_login_ok.php" class="form-signin"
                    ...
                    <button class="button" onclick="location.href='http://49.247.136.36/main/member/register_first.php'">회원가입</button>
                    &nbsp;
                    <br>
                    <br>
                    <div style="text-align:end;">
                    <a href="http://49.247.136.36/main/member/find_id.php" style="color:#000000; ">아이디 찾기</a> /
                    <a href="http://49.247.136.36/main/member/find_password.php" style="color:#000000; ">비밀번호 찾기</a>
                    </div>
