...
// url 흐름 - seller/request_first.php -> seller/request_second.php -> seller/request_chk.php
...
{
    $_SESSION['URL'] = 'http://49.247.136.36/main/seller/request_second.php'; //이 페이지로 다시 되돌아 오기 위해 세션에 이 페이지의 URL을 넣는다.
    ...
    <div id="page-wrapper">
        ...
        <div id="main" class="wrapper style1">
            ...
            <div class="card card-container" style="border:4px solid black; text-align: center;">
                ...
                <form method="post" action="request_chk.php" name="loginForm">

                    <br><br>

                    <h1 style="color:#000000; font-weight: bold; font-size: 1.2em; text-align:left;"><?php echo $email;?>님</h1>

                    <br>

                    <h1 style="color:#000000; font-weight: bold; font-size: 1em; text-align:left;">사이트 URL을 입력해주세요</h1>
                            <input type="url" id="shop_url"
                                   style="width:400px;height:30px;padding:2px; font-size:12pt;"
                                   placeholder="사이트 url" name="shop_url" required autofocus>
                            <br> <br>
                    <h1 style="color:#000000; font-weight: bold; font-size: 1em; text-align:left;">상호명을 입력해주세요</h1>

                            <input type="text" id="shop_name"
                                   style="width:400px;height:30px;padding:2px; font-size:12pt;"
                                   placeholder="상호명" name="shop_name" required>
                            <br> <br>

                    <h1 style="color:#000000; font-weight: bold; font-size: 1em; text-align:left;">고객센터 전화번호를 입력해주세요</h1>

                            <input type="tel" id="shop_phone" maxlength=12
                                   style="width:400px;height:30px;padding:2px; font-size:12pt;"
                                   name="shop_phone" placeholder="'-'없이 ex.01012345678" required>
                            <br> <br>
                    <h1 style="color:#000000; font-weight: bold; font-size: 1em; text-align:left;">카카오톡 ID를 입력해주세요</h1>

                            <input type="text" id="shop_kakao_id" maxlength=40
                                   style="width:400px;height:30px;padding:2px; font-size:12pt;"
                                   placeholder="카카오톡 ID" name="shop_kakao_id" required>
                            <br> <br>
