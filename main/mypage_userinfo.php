...
{
    $_SESSION['URL'] = 'http://49.247.136.36/main/mypage_userinfo.php'; //이 페이지로 다시 되돌아 오기 위해 세션에 이 페이지의 URL을 넣는다.
        ...
        <div id="main" class="wrapper style1">
            ...
            <div class="userinfo_box" style="text-align:center;">
                ...
                <div class="info_box" style="text-align:center;">
                    ...
                    <br><br><br>
                    <button class="button"
                            onclick="location.href ='http://49.247.136.36/main/mypage_change_bodysize.php'">신체정보 수정
                    </button>
                    <br><br><br>
                    <button class="button" onclick="location.href ='http://49.247.136.36/main/mypage_change_pw.php'">
                        비밀번호 변경
                    </button>
                    <br><br><br>
                    <button class="button"
                            onclick="location.href ='http://49.247.136.36/main/mypage_member_withdraw.php'">회원탈퇴
                    </button>
