...
<div id="product_top_box">
    <div id="product_top_left">
        <div class="top_image" style="background-image:url('<?php echo $top_image[0];?>'); background-size:100% 100%;"></div>
    ...
    <div id="product_top_right">
        <div class="product_top_shop_name">로파이</div>
        <div class="product_top_name">12/12 배송 더플코트 유니섹스 (네이비)</div>
        <div class="product_top_price">171,000</div>
...
<div id="product_center_category_box">
    ...
    <div class="product_center_category">배송정보</div>
</div>
<div id="product_center_contents_box">
    <div class="product_center_contents">
        <div class="contents_text">11/22 오전 10시40분 이후 주문건 - 12/05 예약배송<br>12/03 오후 15시30분 이후 주문건 - 12/12 예약배송</div>
        ...
        <img class="contents_image1" src="./contents_temp_image/1.jpg">
        <img class="contents_image2" src="./contents_temp_image/2.jpg">
        <img class="contents_image3" src="./contents_temp_image/3.jpg">
        <img class="contents_image4" src="./contents_temp_image/4.jpg">
    </div>
    <div class="product_center_contents">
