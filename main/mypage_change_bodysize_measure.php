...
{
    $_SESSION['URL'] = 'http://49.247.136.36/main/mypage_change_bodysize_measure.php'; //이 페이지로 다시 되돌아 오기 위해 세션에 이 페이지의 URL을 넣는다.
            ...
            <div class="userinfo_box" style="text-align:center;">
                ...
                <div class="info_box" style="text-align:center;">
                    ...
                    <div class="w3-content w3-display-container" style="width:100%; height:36%;">
                        <img src="./mypage_icon/body_measure1.png" style="width:70%; height:100%;">
                    </div>
                ...
                <div class="info_box" style="text-align:center;">
                    ...
                    <div class="w3-content w3-display-container" style="width:100%; height:36%;">
                        <img src="./mypage_icon/body_measure2.png" style="width:100%; height:100%;">
                    </div>
