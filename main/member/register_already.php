  ...
  <div id="page-wrapper">
      ...
      <div id="main" class="wrapper style1">
          ...
          <div class="card card-container" style="border:4px solid black; text-align:center;">
              <h3>해당 번호로 가입된 계정이 존재합니다</h3>

              <button class="button" type="button" onclick="location.href='http://15.165.80.29/oauth/authorize?client_id=ddb9468d-313f-42d7-a584-f7dd91696040&response_type=code&scope=read'">로그인하기</button>

              <button class="button" type="button" onclick="location.href='find_id.php'">아이디 찾기</button>
