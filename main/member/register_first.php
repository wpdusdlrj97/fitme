        ...
        <div id="page-wrapper">
            ...
            <div id="main" class="wrapper style1">
                ...
                <div class="card card-container" style="border:4px solid black;">
                    ...
                    <form id="terms_form" method="get" action="register_second.php" name="termsForm">

                        <section id="fregister_term">
                            <h4>회원가입약관</h4>
                            <textarea readonly style="width:700px; height:140px; text-align:left;">제1장 총 칙
...
(시행일) 이 약관은 2014년 2월 28일부터 시행합니다.</textarea>
                        ...
                        <section id="fregister_private">
                            <h4>개인정보처리방침안내</h4>
                            <textarea readonly style="width:700px; height:140px; text-align:left;">개요 및 목록
...
현 개인정보취급방침의 내용이 변경될 경우에는 개정 최소 7일전부터 홈페이지의 "공지사항"을 통해 고지 하겠습니다.</textarea>
                        ...
                        <br>
                        <section id="fregister_marketing">
                            <h4>마케팅정보 수신동의</h4>
                            <textarea readonly style="width:700px; height:100px; text-align:left;">
...
② LF는 서비스를 운용함에 있어 각종 정보를 서비스 화면, 전화, e-mail, SMS, 우편물, 앱푸시 등의 방법으로LF Members 회원에게 제공할 수 있으며, LF Members 마일리지 적립 및 소진/소멸 등, 의무적으로 안내되어야 하는 정보성 내용은 수신동의 여부와 무관하게 제공됩니다.</textarea>
                            ...
                            <fieldset class="fregister_agree">
                                <label for="agree31">(선택) 광고성 정보 수신에 동의합니다.</label>
                                <input type="checkbox" name="agree3" value="1" id="check_3">
                            </fieldset>
                        </section>
