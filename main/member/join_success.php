 ...
 *  페이지 이름 - 회원가입 완료 페이지
 *
 *  페이지 흐름 - join_okay.php  ->  join_success.php
 *
 *
 *  페이지 설명 - 회원가입 완료 페이지로 로그인으로 이동하거나 메인으로 이동가능하다
 *
 *
 */
...
<style>
    ...
    #member_box_content_title_box{ margin-top: 50px; width:100%; float: left; background-color: white}

    #member_box_content_title{ margin: 0px; font-size: 24px;}

    #member_box_content_info_box{ margin-top: 15px; width:100%; float: left; background-color: white}
    ...
    @media (max-width:990px)
    {
        ...
        #member_box_image{ margin-left: 15px; width:100px; float: left; height:100px;}
    ...
    @media (max-width:600px)
    {
        ...
        #member_box_image{ margin-left: 10px; margin-right: 15px; margin-bottom: 10px; width:70px; float: left; height:70px;}
    ...
    <div id="registerpage_box">
        ...
        <div id="registerpage_box_inside">
            ...
            <div id="title_box" style="text-align: center;">
                ...
                <p style="font-size: 17px; margin-left: 5px; font-weight: bolder">Membership</p>
            ...
            <div id="content_box" >
                ...
                <div id="member_box_content">
                    ...
                    <div id="member_box_content_title_box">
                        ...
                        <h1 id="member_box_content_title">회원가입이 완료되었습니다</h1>
                    ...
                    <div id="member_box_content_info_box">
                        ...
                        <h1 id="member_box_content_info">
                            <span style="font-weight: bold"> 조제연 </span>님의 회원가입을 축하드립니다
                            <br>
            ...
            <div id="check_box_finish">
                ...
                <button class="button" type="button" onclick="location.href='http://49.247.136.36/main/main.php'">홈으로 가기</h1></button>
