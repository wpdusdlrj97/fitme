 ...
 *  페이지 이름 - 아이디 찾기 페이지
 *
 *  페이지 흐름 - fitme_session_login.php -> find_id.php -> find_id_okay.php
 *
 *
 *  페이지 설명 - 이름과 이메일(중복X)을 입력하면 DB 검출을 통해 아이디를 찾아낸다
 *
 *
 */
...
<style>
    ...
    #member_box_content_info_box{ margin-top: 60px; width:100%;  float: left; background-color: white}
    ...
    #check_box{ margin:0 auto; padding: 10px; width:988px; height:750px;  float: left; background-color: white }
    ...
    @media (max-width:650px)
    {
        ...
        #registerpage_box{ height: 450px;}
        #registerpage_box_inside{ height: 450px;}


        #member_box_image{ margin-left: 0px; margin-bottom:15px; width:70px; float: left; height:70px;}
...
<div id="center_box" >
    ...
    <div id="registerpage_box">
        ...
        <div id="registerpage_box_inside">
            ...
            <form id="find_id_form" method="post" action="find_id_okay.php" name="find_id_form">
                ...
                <div id="content_box" >
                    ...
                    <div id="member_box_image" >
                        ...
                        <img id='image_success' src="http://49.247.136.36/main/member/id.png" alt="My Image">
                ...
                <div id="check_box_finish">
                    ...
                    <button class="button" type="button" id="find_id_button">아이디 찾기</h1></button>
