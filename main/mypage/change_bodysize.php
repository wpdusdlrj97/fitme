...
{
    $_SESSION['URL'] = 'http://49.247.136.36/main/mypage/change_bodysize.php'; //이 페이지로 다시 되돌아 오기 위해 세션에 이 페이지의 URL을 넣는다.
    ...
    <div id="page-wrapper">
        ...
        <div id="main" class="wrapper style1">
            ...
            <div class="userinfo_box" style="text-align:center;">
                ...
                <form action="http://49.247.136.36/main/mypage/change_bodysize_ok.php" accept-charset="utf-8"
                    ...
                    <div class="info_box" style="text-align:center;">
                        ...
                        <table class="type03" style="color:#000000; font-size: 0.9em; ">
                            <tr>
                                <th scope="row">키</th>
                                <td><input type="number" name="height" min="1" max="250" value="<?php if ($row['height_length'] == null or $row['height_length']=="") {
                                        //값이 없을 경우
                                        echo "입력해주세요";
                                    } else {
                            ...
                            <tr>
                                <th scope="row">몸무게</th>
                                <td><input type="number" name="weight" min="1" max="250" value="<?php if ($row['weight'] == null or $row['weight']=="") {
                                        //값이 없을 경우
                                        echo "입력해주세요";
                                    } else {
                                        echo $row['weight'];
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="waist" min="1" max="250" value="<?php if ($row['waist_size'] == null or $row['waist_size']=="") {
                                        //값이 없을 경우
                                        echo "입력해주세요";
                                    } else {
                                        echo $row['waist_size'];
                    ...
                    <div class="info_box" style="text-align:center;">
                        ...
                        <table class="type03" style="color:#000000; font-size: 0.9em; ">
                            <tr>
                                ...
                                <td><input type="number" name="top" min="1" max="250" value="<?php if ($row['top_length'] == null or $row['top_length']=="") {
                                        //값이 없을 경우
                                        echo "입력해주세요";
                                    } else {
                                        echo $row['top_length'];
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="shoulder" min="1" max="250" value="<?php if ($row['shoulder_length'] == null or $row['shoulder_length']=="") {
                                        //값이 없을 경우
                                        echo "입력해주세요";
                                    } else {
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="chest" min="1" max="250" value="<?php if ($row['chest_size'] == null or $row['chest_size']=="") {
                                        //값이 없을 경우
                                        echo "입력해주세요";
                                    } else {
                                        echo $row['chest_size'];
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="arm" min="1" max="250" value="<?php if ($row['arm_length'] == null or $row['arm_length']=="") {
                                        //값이 없을 경우
                                        echo "입력해주세요";
                                    } else {
                                        echo $row['arm_length'];
                    ...
                    <div class="info_box" style="text-align:center;">
                        ...
                        <table class="type03" style="color:#000000; font-size: 0.9em; ">
                            <tr>
                                ...
                                <td><input type="number" name="leg" min="1" max="250" value="<?php if ($row['leg_length'] == null or $row['leg_length']=="") {
                                        //값이 없을 경우
                                        echo "입력해주세요";
                                    } else {
                                        echo $row['leg_length'];
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="hip" min="1" max="250" value="<?php if ($row['hip_size'] == null or $row['hip_size']=="") {
                                        //값이 없을 경우
                                        echo "입력해주세요";
                                    } else {
                                        echo $row['hip_size'];
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="thigh" min="1" max="250" value="<?php if ($row['thigh_size'] == null or $row['thigh_size']=="") {
                                        //값이 없을 경우
                                        echo "입력해주세요";
                                    } else {
                                        echo $row['thigh_size'];
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="ankle" min="1" max="250" value="<?php if ($row['ankle_size'] == null or $row['ankle_size']=="") {
                                        //값이 없을 경우
                                        echo "입력해주세요";
                                    } else {
                                        echo $row['ankle_size'];
                    ...
                    <button id="submit_b" class="button">수정 완료</button>
                    <button class="button" type="button" onclick="location.href='http://49.247.136.36/main/mypage/bodysize_measure.php'">사이즈 측정법</button>
                </form>
