...
{
    $_SESSION['URL'] = '\'http://49.247.136.36/main/mypage/member_withdraw_final.php'; //이 페이지로 다시 되돌아 오기 위해 세션에 이 페이지의 URL을 넣는다.
    ...
    <div id="page-wrapper">
        ...
        <div id="main" class="wrapper style1">
            ...
            <div class="card card-container" style="border:4px solid black; text-align:center;"  >
                <form method="post" action="http://49.247.136.36/main/mypage/member_withdraw_chk.php" class="form-signin"
                      name="loginForm">
