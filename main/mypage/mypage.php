...
{
    $_SESSION['URL'] = 'http://49.247.136.36/main/mypage/mypage.php'; //이 페이지로 다시 되돌아 오기 위해 세션에 이 페이지의 URL을 넣는다.
    ...
    <div id="page-wrapper">
        ...
        <div id="main" class="wrapper style1">
            ...
            <div class="card card-container" style="border:1px solid black;height: 230px;">
                ...
                <div class="menu_box">
                    <h4 style="font-weight: bold;"><a href="http://49.247.136.36/main/mypage/userinfo.php">회원정보</a>
                    </h4>
                    <br>
                    <a href="http://49.247.136.36/main/mypage/userinfo.php">
                        <img src="http://49.247.136.36/main/mypage_icon/mypage_icon_member.png" alt="Avatar" style="width:110px">
                    </a>
                </div>
                ...
                <div class="menu_box">
                    ...
                    <br>
                    <a href="#">
                        <img src="http://49.247.136.36/main/mypage_icon/mypage_icon_cart.png" alt="Avatar" style="width:110px">
                    </a>
                </div>
                ...
                <div class="menu_box">
                    ...
                    <br>
                    <a href="#">
                        <img src="http://49.247.136.36/main/mypage_icon/mypage_icon_item.png" alt="Avatar" style="width:110px">
                    </a>
                </div>
                ...
                <div class="menu_box">
                    ...
                    <a href="http://49.247.136.36/web/mainpage.php">
                        <img src="http://49.247.136.36/main/mypage_icon/mypage_icon_fitme.png" alt="Avatar" style="width:110px">
                    </a>
                </div>
