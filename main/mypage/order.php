...
{
    $_SESSION['URL'] = 'http://49.247.136.36/main/mypage/order.php'; //이 페이지로 다시 되돌아 오기 위해 세션에 이 페이지의 URL을 넣는다.
    ...
    <div id="mypage_box">
        ...
        <div id="menu_box">
            ...
            <ul style="margin-top: 50px;">
                <li><a class="active" href="http://49.247.136.36/main/mypage/order.php">주문조회</a></li>
