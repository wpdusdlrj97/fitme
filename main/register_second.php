  ...
  <div id="page-wrapper">
      ...
      <div id="main" class="wrapper style1">
          ...
          <div class="card card-container" style="border:4px solid black;">
              <a href ="http://49.247.136.36/main/main.php"><h1 style="color:#000000; font-weight: bold; font-size: 3.5em; text-align:center;">회원가입</h1></a>
              <form method="post" action="join_okay.php" name="loginForm">
                  <input type="email" id="inputEmail" maxlength=40 style="width:270px;height:40px;margin-top:20px;padding:2px; font-size:12pt;" placeholder="이메일을 입력해주세요" name="joinid" required autofocus>

                  <button type="button" class="button" onclick="chid();">중복확인</button>
                  <input type=hidden id="chk_id2" name=chk_id2 value="0">

                  <br><br>

                  <input type="password" minlength=8 maxlength=16 id="inputPassword" style="width:270px;height:40px;margin-top:20px;padding:2px; font-size:12pt; " placeholder="비밀번호 (8~16자 영문/숫자 조합) " name="joinpw" required>

                  <br><br>

                  <input type="password" minlength=8 maxlength=16 id="inputPassword" style="width:270px;height:40px;margin-top:20px;padding:2px; font-size:12pt;" placeholder="비밀번호를 다시 한번 입력해주세요" name="joinpw2" required>

                  <br><br>

                    <input type="tel" id="number" maxlength=12 style="width:270px;height:40px;margin-top:20px;padding:2px; font-size:12pt;" name="joinnumber" placeholder="'-'없이 ex.01012345678" required>
                    <button type="button" class="button" onclick="phoneAuth();">SMS 전송</button>
                    <div id="recaptcha-container"></div>



                    <input type="text" id="verificationCode" maxlength=6 style="width:270px;height:40px;margin-top:20px;padding:2px; font-size:12pt;"  placeholder="인증번호 6자리" required>
