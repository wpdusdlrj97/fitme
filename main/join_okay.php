...
//    echo "<meta http-equiv='refresh' content='0; url=$connect_url'>";
    ...
    if($row_phone[0]==0){ // 해당 폰번호로 가입된 계정이 없다면 register_third.php로 보내주기

      $connect_url = 'http://49.247.136.36/main/register_success.php';
      echo "<meta http-equiv='refresh' content='0; url=$connect_url'>";

    }else{ //이미 해당 폰번호로 가입된 계정이 있다면 register_already.php로 보내주기

      $connect_url = 'http://49.247.136.36/main/register_already.php';
      echo "<meta http-equiv='refresh' content='0; url=$connect_url'>";
