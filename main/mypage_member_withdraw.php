...
{
    $_SESSION['URL'] = 'http://49.247.136.36/main/mypage_member_withdraw.php'; //이 페이지로 다시 되돌아 오기 위해 세션에 이 페이지의 URL을 넣는다.
    ...
    <div id="page-wrapper">
        ...
        <div id="main" class="wrapper style1">
            ...
            <div class="card card-container" style="border:4px solid black;" >
                ...
                <button class="button" type="button" onclick="location.href='http://49.247.136.36/main/mypage_member_withdraw_final.php'">계속하기</button>
