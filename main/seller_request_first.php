...
// url 흐름 - seller_inquire.php -> seller_request_first.php -> seller_request_second.php
...
{
    $_SESSION['URL'] = 'http://49.247.136.36/main/seller_request_first.php'; //이 페이지로 다시 되돌아 오기 위해 세션에 이 페이지의 URL을 넣는다.
        ...
        <div id="page-wrapper">
            ...
            <div id="main" class="wrapper style1">
                ...
                <div class="card card-container" style="border:4px solid black;">
                    ...
                    <form id="terms_form" method="get" action="seller_request_second.php" name="termsForm">
...
브랜디는 월 2회 정산되며, 판매 수수료와는 별도로 서버 이용료 (45,000원/월 2회 분납, VAT 별도)가 부과됩니다.</textarea>
                        ...
                        <button class="button" type="button"
                                onclick="location.href='http://49.247.136.36/main/seller_inquire.php'">
                            취소
                        </button>
