...
<body id="head_body">
    <div id="login_area">
        <div class="logo"><a href="./main.php">F I T M E</a></div>
        <div class="search">
            <div class="search_box">
                <img src="../web/icon/search.png">
...
<!--                    실시간 순위를 나타냄, 현재는 하드코딩 되어있는 부분 -> 추후에 DB에 연동시켜 순위를 나타내게 할 것 -->
        ...
        <div class="top_box">
            ...
            { ?>
                ...
                <div class="logout"><a href="../fitme_logout.php">LOGOUT</a></div>
                <div class="mypage"><a href="mypage.php">MYPAGE</a></div>
            ...
            ?>
            <div class="shop"><a href="http://49.247.136.36/main/seller_inquire.php">입점문의</a></div>
            ...
            <div class="category_second_box">
                    ...
                    <?php
                        for($ii=0;$ii<count(json_decode($category2[$i]));$ii++)
                        {
                            if($ii==0)
                            {?>
                                <li class="category_value"><a href="./category.php?category1=<?php echo $category1[$i]?>&category2=ALL">ALL</a></li>
