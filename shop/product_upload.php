...
<!--                        제품목록중 대표이미지와 제품상세페이지의 대표이미지들도 첨부해야한다.-->
    ...
    <tr class="center_table_tr">
        ...
        <td class="center_table_write_content">
            <div class="detail_content" style="border: 1px grey solid; width:97%; margin-left:3%; margin-top:15px; margin-bottom:15px; height:870px;">
...
<button onclick="product_upload_top_post()" class="btn btn-primary" style="float:right; width:130px; height:50px; margin-bottom:100px; text-align:center; margin-right:5%; margin-top:20px; font-size:1.2em">등록</button>
</body>
